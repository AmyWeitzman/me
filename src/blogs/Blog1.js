  ...
  return (
    <div className="content">
        ...
        <div className="container">
            ...
            <div className="img">
                <img className="blog-image" src={BANs1} alt="Body Area Networks"/> 
            </div>
            ...
            <div className="img">
                <img className="blog-image" src={BANs3} alt="Applications of Body Area Networks" width="500px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs2} alt="Components of Body Area Networks" width="350px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs4} alt="BodyMAC Frame Structure" width="500px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs8} alt="Sleep Mode" width="250px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs5} alt="Concept of a Body Area Network" width="550px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs6} alt="BANs Connect to Healthcare Providers" width="550px"/>
            ...
            <div className="img">
                <img className="blog-image" src={BANs7} alt="BANs Provide Privacy and Security" width="550px"/>
