...
function Blog6() {
  return (
    <div className="content">
      ...
      <div className="img">
        <img className="blog-image" src={cs_icon} alt="Computer Science Icon with Computer" width='400px'/> 
      </div>
      ...
      <div className="img">
        <img className="blog-image" src={compiling} alt="Code Compiling Message" width='300px'/> 
      </div>
    ...
    <div className="img">
        <img className="blog-image" src={cs_possibilities} alt="Various topics in computer science" width='400px'/> 
      </div>
    ...
    <div className="img">
        <img  className="blog-image"src={vr} alt="Child using virtual reality headset to explore planets in outer space" width='400px'/> 
      </div>
